<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="addquestion.aspx.cs" Inherits="Online_Examination_System.WebForm9" %>
     ...
     <div class="col-md-12">
        <div class="card">
            ...
            <div class="btn-group mt-1">
                <asp:Button ID="btn_panelquestion" runat="server" Text="Add Question" CssClass="btn btn-primary rounded-2" BorderStyle="None" CausesValidation="False" />
            </div>
            <div class="card-body">
                ...
                <div class="card-footer">
                        <div class="offset-2">
                            <asp:Button ID="btn_addquestion" runat="server" Text="Add Question" CssClass="btn btn-primary"  BorderStyle="None" ForeColor="White" OnClick="btn_addquestion_Click"  />
                        </div>
